<?php
    ...
    if ($_REQUEST["operation"]=="afficher_toutes_les_courses") {
        $resultat = afficher_toutes_les_courses(se_connecter());
    }
    elseif ($_REQUEST["operation"]=="filtrer_les_courses") {
        $resultat = filtrer_les_courses(se_connecter(), $_REQUEST['plaque']);
    }
    elseif ($_REQUEST["operation"]=="detailler_course") {
        $resultat = detailler_course(se_connecter(), $_REQUEST['idcourse']);
    }
