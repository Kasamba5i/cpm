<?php
    ...
    function recuperer_type_compte($idutilsateur){
        ...
        foreach($rows as $row):
            if ($row["typecompte"]=="SUA") {
                $retour = "SUPER ADMINISTRATEUR";
            }
            elseif ($row["typecompte"]=="ADMIN") {
    ...
    if ($_GET["operation"]=="afficher_tous_les_utilisateurs") {
      $resultat = afficher_tous_les_utilisateurs(se_connecter());
    }
    elseif ($_GET["operation"]=="filtrer_les_utilisateurs") {
      $resultat = filtrer_les_utilisateurs(se_connecter(), $_GET["nom"]);
    }
    elseif ($_GET["operation"]=="compter_utilisateurs") {
