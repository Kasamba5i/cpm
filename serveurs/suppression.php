<?php
    ...
    */
    ...
    if ($_GET["operation"]=="supprimer_un_camion") {
        $resultat = supprimer_un_camion();
    }
    elseif ($_GET["operation"]=="supprimer_tous_les_camions") {
        $resultat = supprimer_tous_les_camions();
    }
    elseif ($_GET["operation"]=="supprimer_un_checkpoint") {
        $resultat = supprimer_un_checkpoint();
    }
    elseif ($_GET["operation"]=="supprimer_tous_les_checkpoints") {
        $resultat = supprimer_tous_les_checkpoints();
    }
    elseif ($_GET["operation"]=="supprimer_un_utilisateur") {
